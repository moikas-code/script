...
fn main() {
    ...
    test_semantic_analysis("Example 1: Undefined variable", r#"
        let x = 10;
        y = 20;  // Error: y is not defined
    "#);
    
    // Example 2: Duplicate variable
    test_semantic_analysis("Example 2: Duplicate variable", r#"
        let x = 10;
        let x = 20;  // Error: x already defined
    "#);
    
    // Example 3: Wrong function arguments
    test_semantic_analysis("Example 3: Wrong function arguments", r#"
    ...
    test_semantic_analysis("Example 4: Undefined function", r#"
        let result = multiply(5, 3);  // Error: multiply not defined
    "#);
    
    // Example 5: Variable shadowing (should work)
    test_semantic_analysis("Example 5: Variable shadowing (valid)", r#"
        let x = 10;
        {
    ...
    test_semantic_analysis("Example 6: Return outside function", r#"
        let x = 10;
