...
fn test_generic_function_execution() {
    ...
    assert_eq!(
        result, 42,
        "Generic function should return the correct value"
    );
}
...
fn test_generic_with_multiple_parameters() {
    ...
    assert_eq!(
        result, 42,
        "Generic function with multiple type parameters should work"
    );
}
