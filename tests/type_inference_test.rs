...
mod type_inference_tests {
    ...
    fn test_simple_struct_inference() {
        ...
        assert!(instantiations.iter().any(|inst| 
            inst.function_name == "Box::new" && 
    ...
    fn test_nested_generic_inference() {
        ...
        assert!(instantiations.iter().any(|inst| inst.function_name.starts_with("Box")));
        assert!(instantiations.iter().any(|inst| inst.function_name.starts_with("Option")));
    }
